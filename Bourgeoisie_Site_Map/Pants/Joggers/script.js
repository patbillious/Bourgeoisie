...
const items = [
  new Product({
    ...
    name: "Jogger Pants",
    shirtColor: "Moss",
    img: "https://res.cloudinary.com/dzs3y7aj6/image/upload/v1760723608/image_24_bsjrp3.png",
    materials: "100% Cotton",
    info: "Oversized fit, ultra-soft fleece interior, premium streetwear for cool evenings.",
    price: 69.99
  }),
  new Product({
    id: '1',
    name: "Jogger Pants",
    shirtColor: "Sand",
    img: "https://res.cloudinary.com/dzs3y7aj6/image/upload/v1760723608/image_7_fgr7md.png",
    materials: "100% Cotton",
    info: "Relaxed fit with adjustable waist and multiple pockets. For the urban explorer.",
    price: 69.99
  }),
  new Product({
    id: '2',
    name: "Jogger Pants",
    shirtColor: "Blue",
    img: "https://res.cloudinary.com/dzs3y7aj6/image/upload/v1760723602/image_4_drbtai.png",
    materials: "100% Organic Cotton",
    info: "Breathable, bold print, eco-conscious. Make a statement every day.",
    price: 29.99
  }),
  new Product({
    id: '3',
    name: "Jogger Pants",
    shirtColor: "Pink",
    img: "https://res.cloudinary.com/dzs3y7aj6/image/upload/v1760723601/image_11_mci2oo.png",
    materials: "100% Organic Cotton",
    info: "Breathable,eco-conscious. Relaxed fit with adjustable waist and multiple pockets. For the urban explorer.",
    price: 69.99
  }),
    ...
    name: "Jogger Pants",
    shirtColor: "Purple",
    img: "https://res.cloudinary.com/dzs3y7aj6/image/upload/v1760723601/image_46_c5tylj.png",
    materials: "100% Organic Cotton",
    info: "Relaxed fit with adjustable waist and multiple pockets. For the urban explorer.Breathable, bold print, eco-conscious. Make a statement every day.",
    price: 69.99
  }),
    ...
    name: "Jogger Pants",
    shirtColor: "Black",
    img: "https://res.cloudinary.com/dzs3y7aj6/image/upload/v1760723607/image_front_blk_ozfs0r.png",
    materials: "100% Organic Cotton",
    info: "Breathable, bold print, eco-conscious. Make a statement every day.",
    price: 69.99
  }),
    ...
    name: "Jogger Pants",
    shirtColor: "White",
    img: "https://res.cloudinary.com/dzs3y7aj6/image/upload/v1760723597/image_10_azpmur.png",
    materials: "100% Organic Cotton",
    info: "Breathable, bold print, eco-conscious. Fit for the modern minimalist.",
    price: 69.99
  }),
];
